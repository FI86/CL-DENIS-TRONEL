...
class JeuDeCartes:
    ...
    def __init__(self):
        ...
        # liste de cartes : solution 1
        for couleur in self.couleurs:
            for valeur in self.valeurs:
                self.cartes.append((valeur, couleur))
        
        # liste de cartes : solution 2
        from itertools import product
        # transforme en liste car product de itertools creer un iterateur
        # (lisible qu'une fois)
        self.cartes = list(product(self.valeurs, self.couleurs))
